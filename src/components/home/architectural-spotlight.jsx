...
export default function ArchitecturalSpotlight() {
  return (
    <section className="mt-12 space-y-4">
      <h2 className="text-3xl font-semibold text-[var(--color-text)]">{spotlightContent.sectionLabel}</h2>
      <CardShell className="overflow-hidden p-0">
        ...
        <div className="space-y-4 px-6 py-8 md:px-10">
          ...
          <h3 className="text-4xl font-semibold text-[var(--color-text)]">{spotlightContent.title}</h3>
